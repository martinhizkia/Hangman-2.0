...
// boxBorder(45,1,20,1,22,1,1);//tiang horizontal
  //  boxBorder(45,1,1,20,22,1,1);//tiang vertikal
    ...
    boxBorder(37,4,8,1,g,1,1);//hri
    boxBorder(37,2,2,5,g,1,1);//ver
    boxBorder(45,2,2,5,g,1,1);// H

    boxBorder(48,4,2,3,g,1,1);
    boxBorder(48,2,8,1,g,1,1);
    boxBorder(48,4,8,1,g,1,1);
    boxBorder(55,2,2,5,g,1,1);
    boxBorder(48,6,8,1,g,1,1);
    //a

    boxBorder(58,2,8,1,g,1,1);
    boxBorder(58,2,2,5,g,1,1);
    boxBorder(58,2,2,5,g,1,1);
    boxFill(65,2,2,5,g);
...
void menu(){
    ...
    boxFill(14,17,16,7,arrow(1,posisi));

    boxFill(16,18,12,1,c);
    boxFill(16,18,2,2,c);
    boxFill(16,20,12,1,c);
    boxFill(26,20,2,2,c);
    boxFill(16,22,12,1,c);
    gotoxy(15,24);
    printf("SINGLE PLAYER");
    boxFill(33,17,16,7,arrow(2,posisi));

    boxFill(35,18,11,1,c);
    boxFill(35,18,2,5,c);
    boxFill(40,18,2,5,c);
    boxFill(45,18,2,5,c);
    gotoxy(35,24);
    printf("MULTIPLAYER");
     ...
     boxFill(52,17,16,7,arrow(3,posisi));
    boxFill(54,18,12,1,c);
    boxFill(54,18,2,2,c);
    boxFill(54,20,12,1,c);
    boxFill(64,20,2,2,c);
    boxFill(54,22,12,1,c);
    gotoxy(54,24);
    printf("SCOREBOARD");

    boxFill(70,17,16,7,arrow(4,posisi));
    ...
    boxFill(88,17,16,7,arrow(5,posisi));
...
if(posisi == 3){
     /* PRINT LINKED LISTNYA DISINI VAAAAA*/
